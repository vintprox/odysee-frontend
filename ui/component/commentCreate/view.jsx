  ...
  return (
    ...
    >
      ...
      {stickerSelector ? (
        ...
        <div className="comment__create--sticker-preview">
          <div className="comment__sticker-preview">
            <div className="comment__sticker-preview--info">
        ...
        {isReviewingSupportComment ? (
          ...
          <Button
            ...
            disabled={
              ...
              (convertedAmount && activeTab !== TAB_FIAT && convertedAmount < selectedSticker.price)
            }
            onClick={() => {
              if (isSupportComment) {
